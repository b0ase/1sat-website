 ...
 */
export const handCashConnected = signal<boolean>(false);
export const handCashUser = signal<any>(null);
export const handCashAccount = signal<any>(null);
export const showHandCashModal = signal<boolean>(false);
