...
import HandCashLoginButton from "../HandCash/LoginButton";
    ...
    <ul className="dropdown dropdown-end">
      ...
      {showDropdown.value && (
        ...
        >
          ...
          {!payPk.value && !ordPk.value && !handCashConnected && (
            <>
          ...
          {handCashConnected && handCashUser && (
            <>
              ...
              <div className="divider">HandCash Wallet</div>
            </>
          )}
        </ul>
      )}
